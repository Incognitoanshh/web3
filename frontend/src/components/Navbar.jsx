    ...
    <Navbar isBordered position="sticky" maxWidth="full">
      ...
      {props.address && (
        <NavbarContent justify="center">
          ...
          <NavbarItem isActive={activeLink === "transactionHistory"}>
            <Link
              color={getColor("transactionHistory")}
              onClick={() => handleLinkClick("transactionHistory")}
              href="/transaction-history"
            >
              Transaction History
            </Link>
          </NavbarItem>
          <NavbarItem isActive={activeLink === "unvResolver"}>
            <Link
              color={getColor("unvResolver")}
              onClick={() => handleLinkClick("unvResolver")}
              href="/unv-resolver"
            >
              UNV Resolver
            </Link>
