...
function App() {
  ...
  useEffect(() => {
    console.log(
      "✅ VITE_DATA_REQUEST_CONTRACT:",
      import.meta.env.VITE_DATA_REQUEST_CONTRACT
    );
    console.log(
      "✅ VITE_IDENTITY_CONTRACT:",
    ...
    const fetchUserDetails = async () => {
      ...
      try {
        ...
        if (isMounted) {
          setLoading(false);
          console.log(loading);
        } // End loading only if still mounted
      }
    };
      ...
      <NextUIProvider navigate={navigate}>
        ...
        >
          ...
          <Routes>
            ...
            />
            <Route exact path="/unv-resolver" element={<UNVResolver />} />
          </Routes>
          {/* </main> */}
        </NextThemesProvider>
      </NextUIProvider>
